...
class ExcelComPlugin(HarnessPlugin):
    ...
    def build_system_prompt(self, file_path: str, file_summary: dict,
        ...
        return (
            ...
            "## Pivot Table Example\n"
            "When user asks to create a pivot table:\n"
            "1. Call `excel_com_open`\n"
            "2. Call `excel_com_create_pivot` with source_sheet, source_range, row_fields, value_fields, col_fields, dest_sheet, name\n"
            ...
            "- ALWAYS call tools when asked to perform an action. Never just describe steps.\n"
